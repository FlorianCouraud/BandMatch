...
user4.save!
user5 = User.new(first_name: "Jimmy", last_name: "Hendrix", age: "19", address: "127 avenue du Prado, Marseille", city:"Marseille", email: "jhendrix@gmail.com", password: "123456", link1: "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/483863739&color=%23ff5500&inverse=false&auto_play=false&show_user=true")
...
user5.save!
user6 = User.new(first_name: "Eric", last_name: "Clapton", age: "52", address: "venice beach, Miami",city:"Miami", email: "eclapton@gmail.com", password: "123456", link1: "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/480660528&color=%23ff5500&inverse=false&auto_play=false&show_user=true")
...
user6.save!
user7 = User.new(first_name: "Kurt", last_name: "Cobain", age: "27", address: "444 Brickell Ave, Miami", city: "Miami", email: "kcobain@gmail.com", password: "123456", link1: "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/294076069&color=%23ff5500&inverse=false&auto_play=false&show_user=true")
...
user10.save!
user11 = User.new(first_name: "Thomas", last_name: "MP", age: "24", address: "102 rue du cimetière, Saint Maximin La Sainte Baume", city:"Saint Maximin La Sainte Baume", email: "thomas-mp@gmail.com", password: "123456", link1: "https://w.soundcloud.com/player/?url=https%3A//api.soundcloud.com/tracks/218004927&color=%23ff5500&inverse=false&auto_play=false&show_user=true")
