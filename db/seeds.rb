...
user1 = User.new(first_name: "Wilfried", last_name: "Bessovi", age: "30", address: "64 avenue du Prado, Marseille", city: "Marseille", email: "wbsvnet@gmail.com", password: "123456", link1: "https://soundcloud.com/poltergasmic/gnap")
...
user1.save!
user2 = User.new(first_name: "Jessica", last_name: "Fiedler", age: "25", address: "49 rue de la Republique, Marseille", city: "Marseille", email: "jess.fiedler83860@gmail.com", password: "123456", link1: "https://soundcloud.com/markus-saarlander/bruno-otranto-brighton-berlin-mixtape-028-monog-records-compilation")
...
user2.save!
user3 = User.new(first_name: "Florian", last_name: "Couraud", age: "27", address: "12 rue de Rome, Marseille", city: "Marseille", email: "f.couraud13@gmail.com", password: "123456", link1: "https://soundcloud.com/mathew-jonson/panna-cotta")
...
user3.save!
user4 = User.new(first_name: "Brice", last_name: "Bickelmann", age: "25", address: "5 avenue des champs-élysées, Paris", city: "Paris", email: "bickelmann.b@gmail.com", password: "123456", link1: "https://soundcloud.com/burst-noise/petrichor")
...
user4.save!
user5 = User.new(first_name: "Jimmy", last_name: "Hendrix", age: "19", address: "127 avenue du Prado, Marseille", city:"Marseille", email: "jhendrix@gmail.com", password: "123456", link1: "https://soundcloud.com/epicmountain/wormholes")
...
user5.save!
user6 = User.new(first_name: "Eric", last_name: "Clapton", age: "52", address: "venice beach, Miami",city:"Miami", email: "eclapton@gmail.com", password: "123456", link1: "https://soundcloud.com/dooly1009/gucci-gang-kawai")
...
user6.save!
user7 = User.new(first_name: "Kurt", last_name: "Cobain", age: "27", address: "444 Brickell Ave, Miami", city: "Miami", email: "kcobain@gmail.com", password: "123456", link1: "https://soundcloud.com/la-decadanse-1/inxs-to-look-at-you-la-decadanse-edit")
...
user7.save!
user8 = User.new(first_name: "Romain", last_name: "Trickster", age: "22", address: "5 cours Mirabeau, Aix-en-Provence", city: "Aix-en-Provence", email: "tricksters@gmail.com", password: "123456", link1: "https://soundcloud.com/silly-joy/silly-joy-hurt-nine-inch-nails-cover")
...
user8.save!
user9 = User.new(first_name: "Raphael", last_name: "Clement", age: "31", address: "142 Boulevard de la République, La Ciotat", city: "La Ciotat", email: "rclement@gmail.com", password: "123456", link1: "https://soundcloud.com/thebandher/five-minutes")
...
user9.save!
user10 = User.new(first_name: "Rose", last_name: "Cobain", age: "27", address: "164 rue paradis, Marseille", city:"Marseille", email: "Rose-dc@gmail.com", password: "123456", link1: "https://soundcloud.com/crosswalk-records/moi-je-profite")
...
user10.save!
user11 = User.new(first_name: "Thomas", last_name: "MP", age: "24", address: "102 rue du cimetière, Saint Maximin La Sainte Baume", city:"Saint Maximin La Sainte Baume", email: "thomas-mp@gmail.com", password: "123456", link1: "https://soundcloud.com/kygo/piano-jam")
...
user11.save!
user12 = User.new(first_name: "Simone", last_name: "Simmons", age: "21", address: "21 Allée du Moulin Pinard, Limoges", city:"Limoges", email: "simsimm@gmail.com", password: "123456", link1: "https://soundcloud.com/kartell/kartell-gold-2")
