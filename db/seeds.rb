...
user4.save!
user5 = User.create!(first_name: "Jimmy", last_name: "Hendrix", age: "19", address: "127 avenue du Prado, Marseille", email: "jhendrix@gmail.com", password: "123456")
