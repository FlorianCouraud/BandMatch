...
UserInstrument.create!(user_id: user18.id, instrument_id: ukulele.id, years_of_experience: "2")
...
UserInstrument.create!(user_id: user20.id, instrument_id: ukulele.id, years_of_experience: "5")
UserInstrument.create!(user_id: user21.id, instrument_id: guitar.id, years_of_experience: "8")
UserInstrument.create!(user_id: user21.id, instrument_id: sing.id, years_of_experience: "3")
UserInstrument.create!(user_id: user22.id, instrument_id: drums.id, years_of_experience: "5")
UserInstrument.create!(user_id: user21.id, instrument_id: piano.id, years_of_experience: "7")
UserInstrument.create!(user_id: user22.id, instrument_id: guitar.id, years_of_experience: "2")
UserInstrument.create!(user_id: user23.id, instrument_id: guitar.id, years_of_experience: "6")
UserInstrument.create!(user_id: user23.id, instrument_id: sing.id, years_of_experience: "2")
UserInstrument.create!(user_id: user24.id, instrument_id: guitar.id, years_of_experience: "2")
UserInstrument.create!(user_id: user24.id, instrument_id: sing.id, years_of_experience: "1")
UserInstrument.create!(user_id: user24.id, instrument_id: ukulele.id, years_of_experience: "2")
UserInstrument.create!(user_id: user25.id, instrument_id: guitar.id, years_of_experience: "8")
UserInstrument.create!(user_id: user25.id, instrument_id: piano.id, years_of_experience: "6")
UserInstrument.create!(user_id: user25.id, instrument_id: ukulele.id, years_of_experience: "2")
UserInstrument.create!(user_id: user25.id, instrument_id: sing.id, years_of_experience: "7")
