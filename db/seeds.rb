...
UserStyle.create!(user_id: user15.id, style_id: jazz.id)
UserStyle.create!(user_id: user15.id, style_id: rock.id)
UserStyle.create!(user_id: user15.id, style_id: country.id)
UserStyle.create!(user_id: user16.id, style_id: rock.id)
UserStyle.create!(user_id: user16.id, style_id: pop.id)
UserStyle.create!(user_id: user16.id, style_id: metal.id)
UserStyle.create!(user_id: user17.id, style_id: blues.id)
UserStyle.create!(user_id: user17.id, style_id: folk.id)
UserStyle.create!(user_id: user17.id, style_id: pop.id)
UserStyle.create!(user_id: user17.id, style_id: techno.id)
UserStyle.create!(user_id: user18.id, style_id: indie.id)
UserStyle.create!(user_id: user18.id, style_id: pop.id)
UserStyle.create!(user_id: user19.id, style_id: pop.id)
UserStyle.create!(user_id: user19.id, style_id: rock.id)
UserStyle.create!(user_id: user20.id, style_id: electro.id)
UserStyle.create!(user_id: user20.id, style_id: pop.id)
UserStyle.create!(user_id: user21.id, style_id: electro.id)
UserStyle.create!(user_id: user22.id, style_id: metal.id)
UserStyle.create!(user_id: user23.id, style_id: metal.id)
UserStyle.create!(user_id: user23.id, style_id: blues.id)
UserStyle.create!(user_id: user24.id, style_id: classic.id)
UserStyle.create!(user_id: user24.id, style_id: pop.id)
UserStyle.create!(user_id: user25.id, style_id: rock.id)
UserStyle.create!(user_id: user25.id, style_id: metal.id)
UserStyle.create!(user_id: user26.id, style_id: pop.id)
UserStyle.create!(user_id: user26.id, style_id: electro.id)
UserStyle.create!(user_id: user27.id, style_id: folk.id)
UserStyle.create!(user_id: user27.id, style_id: pop.id)
UserStyle.create!(user_id: user27.id, style_id: rock.id)
UserStyle.create!(user_id: user28.id, style_id: pop.id)
UserStyle.create!(user_id: user28.id, style_id: rock.id)
UserStyle.create!(user_id: user28.id, style_id: folk.id)
UserStyle.create!(user_id: user28.id, style_id: metal.id)
...
UserInstrument.create!(user_id: user18.id, instrument_id: clarinet.id, years_of_experience: "6")
...
UserInstrument.create!(user_id: user20.id, instrument_id: guitar.id, years_of_experience: "2")
...
UserInstrument.create!(user_id: user22.id, instrument_id: guitar.id, years_of_experience: "8")
UserInstrument.create!(user_id: user22.id, instrument_id: sing.id, years_of_experience: "3")
UserInstrument.create!(user_id: user23.id, instrument_id: drums.id, years_of_experience: "5")
UserInstrument.create!(user_id: user24.id, instrument_id: piano.id, years_of_experience: "7")
UserInstrument.create!(user_id: user25.id, instrument_id: guitar.id, years_of_experience: "2")
UserInstrument.create!(user_id: user26.id, instrument_id: guitar.id, years_of_experience: "6")
UserInstrument.create!(user_id: user26.id, instrument_id: sing.id, years_of_experience: "2")
UserInstrument.create!(user_id: user27.id, instrument_id: guitar.id, years_of_experience: "2")
